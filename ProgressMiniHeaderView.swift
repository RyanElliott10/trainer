...
class ProgressMiniHeaderView: UICollectionViewCell {
    ...
    private func setupViews() {
        // TODO: - This will require a substantial amount of work, but make this a section, and the Progress Label the header of this section, with the Workouts label the section header for the workouts section. i.e. `workoutStreakView`, `goalView`, and `chartContainer` will be their own CollectionViewCells
        ...
        NSLayoutConstraint.activate([
            workoutStreakView.topAnchor.constraint(equalTo: progressLabel.bottomAnchor, constant: 8),
        ...
        NSLayoutConstraint.activate([
            goalView.topAnchor.constraint(equalTo: workoutStreakView.topAnchor),
        ...
        NSLayoutConstraint.activate([
            chartContainer.topAnchor.constraint(equalTo: workoutStreakView.bottomAnchor, constant: 8),
